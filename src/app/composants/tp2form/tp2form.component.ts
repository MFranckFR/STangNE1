...
@Component({
  selector: 'app-tp2form',
  templateUrl: './tp2form.component.html',
  styleUrls: ['./tp2form.component.css']
})
export class Tp2formComponent implements OnInit {

  
 // nom = new FormControl('John Doe');
 testValue='champ imput';
